...
Expected files   : Warlock.cpp Warlock.hpp
				   ...
				   Fireball.hpp Fireball.cpp      (ASpell)
				   Polymorph.hpp Polymorph.cpp    (ASpell)
				   BrickWall.hpp BrickWall.cpp    (ATarget)
				   
				   SpellBook.hpp SpellBook.cpp              (class, object in Warlock)
