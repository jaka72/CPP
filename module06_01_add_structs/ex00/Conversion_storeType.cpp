...
/*   Updated: 2022/11/19 13:21:23 by jmurovec      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
int	Conversion::isSingleChar()
{
	...
	if (_isDigit == 1)
	{
		...
		_f = static_cast<float>(_intg);	// IN CASE OF OVERFLOW IT MUST HAVE VALUE FROM
		_d = static_cast<double>(_intg);	// ORIGINAL INPUT
