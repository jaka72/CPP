...
Box::Box()
{
	...
	*_ptr = temp;		// OK
	...
	cout << "   ptr  will go out of scope now!\n";
}
...
void Box::set(int x, int y, int *p)
{
	...
	cout << "Changing _ptr to local temp, inside set()\n";
	int temp 	= 321;
	_ptr		= &temp;
...
int main()
{
	...
	{	// as non pointer
		...
		cout << "\n_ptr value is lost, because it was set in the function set(), now out of scope.\n";
		cout << "But _x value is preserved.\n";
		d1.show();
